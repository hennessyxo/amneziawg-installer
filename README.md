...
```bash
git clone https://github.com/<your-username>/amneziawg-installer.git
...
```bash
curl -fsSL https://raw.githubusercontent.com/<your-username>/amneziawg-installer/main/amneziawg-install.sh -o awg-install.sh
