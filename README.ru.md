...
| Десктоп-приложение — клиенты | Десктоп-приложение — настройки |
|:---:|:---:|
| ![Приложение, вкладка клиентов](docs/img/gui-clients.png) | ![Приложение, вкладка настроек](docs/img/gui-settings.png) |

| Веб-панель — клиенты и трафик | Веб-панель — обзор сервера |
|:---:|:---:|
| ![Веб-панель, список клиентов](docs/img/panel-clients.png) | ![Веб-панель, обзор сервера](docs/img/panel-server.png) |
